...
public class AutomataRunner {
    ...
    public AutomataRunner(StructureWorldAccess world, BlockPos pos, NoiseHandler noiseHandler) {
    ...
    private int fillMaxHeights() {
        ...
        for (int x = 0; x < 17; x++) {
            for (int z = 0; z < 17; z++) {
                int posX = pos.getX() + x;
                int posZ = pos.getZ() + z;
                int height = world.getTopY(Heightmap.Type.OCEAN_FLOOR_WG, posX, posZ);
