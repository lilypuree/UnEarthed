...
public class BlockStates {
    ...
    protected static final BlockState SCHIST_X = getBaseBlock(BlockGeneratorReference.SCHIST).with(Properties.AXIS, Direction.Axis.X);
    protected static final BlockState SCHIST_Y = getBaseBlock(BlockGeneratorReference.SCHIST).with(Properties.AXIS, Direction.Axis.Y);
    protected static final BlockState SCHIST_Z = getBaseBlock(BlockGeneratorReference.SCHIST).with(Properties.AXIS, Direction.Axis.Z);
