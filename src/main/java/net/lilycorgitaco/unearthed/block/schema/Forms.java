...
import net.lilycorgitaco.unearthed.block.*;
...
public class Forms {
    private static class SimpleForm extends BlockSchema.Form {
        ...
        public SimpleForm(String name, Function<AbstractBlock.Settings, Block> blockCreator) {
            super(name);
    ...
    public static final BlockSchema.Form AXISBLOCK = new SimpleForm("", PillarBlock::new);
    public static final BlockSchema.Form BEAM = new SimpleForm("", PillarBlock::new);
