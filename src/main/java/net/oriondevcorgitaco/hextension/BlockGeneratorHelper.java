...
public class BlockGeneratorHelper {
    ...
    private void generateBaseVariant() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, id), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, id)), new Item.Settings().group(HEXTENSION_TAB)));
        Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, slabID), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, slabID)), new Item.Settings().group(HEXTENSION_TAB)));
        Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, stairID), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, stairID)), new Item.Settings().group(HEXTENSION_TAB)));
    ...
    private void generatePolishedVariant(boolean generate) {
        if (generate) {
            ...
            Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, polishedID), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, polishedID)), new Item.Settings().group(HEXTENSION_TAB)));
            Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, polishedSlabID), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, polishedSlabID)), new Item.Settings().group(HEXTENSION_TAB)));
            Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, polishedStairID), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, polishedStairID)), new Item.Settings().group(HEXTENSION_TAB)));
    ...
    private void generateCobbleVariant(boolean generate) {
        if (generate) {
            ...
            Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, cobbleID), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, cobbleID)), new Item.Settings().group(HEXTENSION_TAB)));
            Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, cobbleSlabID), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, cobbleSlabID)), new Item.Settings().group(HEXTENSION_TAB)));
            Registry.register(Registry.ITEM, new Identifier(Hextension.MOD_ID, cobbleStairID), new BlockItem(Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, cobbleStairID)), new Item.Settings().group(HEXTENSION_TAB)));
        }
    }

    public Block getBlock() {
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, this.id));
    }

    public Block getSlabBlock() {
        String slabID = id + "_slab";
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, slabID));
    }

    public Block getStairBlock() {
        String stairID = id + "_stair";
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, stairID));
    }

    public Block getPolishedBlock() {
        String polishedID = "polished_" + this.id;
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, polishedID));
    }

    public Block getPolishedSlabBlock() {
        String polishedID = "polished_" + this.id;
        String polishedSlabID = polishedID + "_slab";
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, polishedSlabID));
    }

    public Block getPolishedStairBlock() {
        String polishedID = "polished_" + id;
        String polishedStairID = polishedID + "_stairs";
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, polishedStairID));
    }

    public Block getCobbleBlock() {
        String cobbleID = id + "_cobble";
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, cobbleID));
    }

    public Block getCobbleSlabBlock() {
        String cobbleID = id + "_cobble";
        String cobbleSlabID = cobbleID + "_slab";
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, cobbleSlabID));
    }

    public Block getCobbleStairBlock() {
        String cobbleID = id + "_cobble";
        String cobbleStairID = cobbleID + "_stairs";
        return Registry.BLOCK.get(new Identifier(Hextension.MOD_ID, cobbleStairID));
    }

    public Item getItem() {
        return Registry.ITEM.get(new Identifier(Hextension.MOD_ID, this.id));
    }

    public Item getSlabItem() {
        String slabID = id + "_slab";
        return Registry.ITEM.get(new Identifier(Hextension.MOD_ID, slabID));
    }

    public Item getStairItem() {
        String stairID = id + "_stair";
        return Registry.ITEM.get(new Identifier(Hextension.MOD_ID, stairID));
    }

    public Item getPolishedItem() {
        String polishedID = "polished_" + this.id;
        return Registry.ITEM.get(new Identifier(Hextension.MOD_ID, polishedID));
    }

    public Item getPolishedSlabItem() {
        String polishedID = "polished_" + this.id;
        String polishedSlabID = polishedID + "_slab";
        return Registry.ITEM.get(new Identifier(Hextension.MOD_ID, polishedSlabID));
    }

    public Item getPolishedStairItem() {
        String polishedID = "polished_" + id;
        String polishedStairID = polishedID + "_stairs";
        return Registry.ITEM.get(new Identifier(Hextension.MOD_ID, polishedStairID));
    }

    public Item getCobbleItem() {
        String cobbleID = id + "_cobble";
        return Registry.ITEM.get(new Identifier(Hextension.MOD_ID, cobbleID));
    }

    public Item getCobbleSlabItem() {
        String cobbleID = id + "_cobble";
        String cobbleSlabID = cobbleID + "_slab";
        return Registry.ITEM.get(new Identifier(Hextension.MOD_ID, cobbleSlabID));
    }
