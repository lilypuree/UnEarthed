...
//
//public class NewGenerator2 extends Feature<NoFeatureConfig> {
//    public NewGenerator2(Codec<NoFeatureConfig> codec) {
//        super(codec);
//    }
//
...
//                return cell.getGrassReplacementDefault();
//            } else if (replaceCobble && original.isIn(Blocks.COBBLESTONE)) {
//                return cell.getCobbleReplacement();
//            } else if (cell.replacesOre()) {
