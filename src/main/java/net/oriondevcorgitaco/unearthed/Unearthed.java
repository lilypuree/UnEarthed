...
//            UEEntities.CLOUD = EntityType.Builder.<CloudEntity>create(CloudEntity::new, EntityClassification.MISC).size(0.25f, 0.25f).trackingRange(8).updateInterval(10).build("cloud");
//            UEEntities.ASTEROID = EntityType.Builder.<AsteroidEntity>create(AsteroidEntity::new, EntityClassification.MISC).size(0.5f, 0.5f).trackingRange(8).updateInterval(10).build("asteroid");
//            event.getRegistry().registerAll(
