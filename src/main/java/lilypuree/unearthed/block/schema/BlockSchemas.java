...
public class BlockSchemas {
    ...
    static {
        ...
        List<BlockVariant> secondary_no_ores = create(SECONDARY_NO_ORES, POLISHED);
        List<BlockVariant> vanilla_like = create(ALL_BLOCKS_NO_ORES);
        ...
        QUARTZITE = register("quartzite", vanilla_like);
