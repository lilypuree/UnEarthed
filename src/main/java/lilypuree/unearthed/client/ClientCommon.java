...
public class ClientCommon {
    public static void initRenderLayers() {
        ...
        Services.PLATFORM.setRenderLayer(Registration.LICHEN.get(), RenderType.cutoutMipped());
    }
    ...
    public static void blockColors() {
        ...
        Services.PLATFORM.setBlockColor(Registration.LICHEN.get(), (blockstate, reader, pos, i) -> {
    ...
    public static void itemColors() {
        ...
        Services.PLATFORM.setItemColor(Registration.LICHEN_ITEM.get(), (stack, color) -> LichenColors.getLichen());
    }
}
