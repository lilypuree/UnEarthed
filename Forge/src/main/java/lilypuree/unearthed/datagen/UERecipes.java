...
public class UERecipes extends RecipeProviderAccessor {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumerIn) {
        consumer = consumerIn;
        stoneRecipe();
        addOreRecipes(consumer, UETags.Items.UNEARTHED_IRON_ORE, VanillaOreTypes.IRON);
        addOreRecipes(consumer, UETags.Items.UNEARTHED_COAL_ORE, VanillaOreTypes.COAL);
        addOreRecipes(consumer, UETags.Items.UNEARTHED_COPPER_ORE, VanillaOreTypes.COPPER);
        addOreRecipes(consumer, UETags.Items.UNEARTHED_GOLD_ORE, VanillaOreTypes.GOLD);
        addOreRecipes(consumer, UETags.Items.UNEARTHED_LAPIS_ORE, VanillaOreTypes.LAPIS);
        addOreRecipes(consumer, UETags.Items.UNEARTHED_REDSTONE_ORE, VanillaOreTypes.REDSTONE);
        addOreRecipes(consumer, UETags.Items.UNEARTHED_DIAMOND_ORE, VanillaOreTypes.DIAMOND);
        addOreRecipes(consumer, UETags.Items.UNEARTHED_EMERALD_ORE, VanillaOreTypes.EMERALD);
...
//        stoneSmeltingRecipeOf(BlockSchemas.MARBLE.getBaseBlock(), BlockSchemas.BEIGE_LIMESTONE.getBaseBlock());
    ...
    private static void addOreRecipes(Consumer<FinishedRecipe> consumer, Tag<Item> oreTag, IOreType oreType) {
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(oreTag), oreType.getSmeltResult(), oreType.getExperience(), oreType.getBlastTime())
                .unlockedBy("has_" + oreType.getName() + "_ore", has(oreTag)).group(getItemName(oreType.getSmeltResult()))
                .save(consumer, getItemName(oreType.getSmeltResult()) + "_from_blasting_" + oreType.getName() + "_ore");
    }
